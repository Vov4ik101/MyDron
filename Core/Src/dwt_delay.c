...
void DWT_Init(void)
{
    // 1. ÂÊËÞ×ÀÅÌ òðàññèðîâêó (ýòî áûëî è åñòü)
    CoreDebug->DEMCR |= CoreDebug_DEMCR_TRCENA_Msk;

    // 2. ÐÀÇÁËÎÊÈÐÓÅÌ äîñòóï ê DWT äëÿ STM32F7/H7/L4/G4/U5 (ÝÒÎ ÊËÞ×ÅÂÎÉ ÌÎÌÅÍÒ!)
    //    Íà F1/F4 ýòà ñòðîêà íå íàâðåäèò, íî è íå íóæíà.
//    DWT->LAR = 0xC5ACCE55;

    // 3. ÑÁÐÀÑÛÂÀÅÌ ñ÷åò÷èê
    DWT->CYCCNT = 0;

    // 4. ÂÊËÞ×ÀÅÌ ñ÷åò÷èê òàêòîâ
